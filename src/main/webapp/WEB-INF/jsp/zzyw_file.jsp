...
<div class="content_box clearfix">
    <div class="vmenu fl">
        <div class="mt80">
            ...
            <ul>
                <has:operate>
                    <li><a href="/filetype/list?tid=zzyw&fid=3" <c:if test="${fid==3}"> class="on" </c:if>><span>增值业务插件包管理</span></a></li>
                </has:operate>
                <has:operate>
                    <li><a href="/filetype/list?tid=zzyw&fid=4" <c:if  test="${fid==4}"> class="on" </c:if>><span>增值业务资源包管理</span></a></li>
                </has:operate>
                <has:operate>
                    <li><a href="/pub/list?tid=zzyw&fid=3" ><span>增值业务插件发布管理</span></a></li>
                </has:operate>
                <has:operate>
                    <li><a href="/pub/list?tid=zzyw&fid=4"><span>增值业务资源发布管理</span></a></li>
                </has:operate>
            </ul>
        </div>
    </div>
    ...
    <div class="formbox">
        <form method="post" action="/filetype/addappsoft" id="add">
            ...
            <div style="display: none;">
                <input type="hidden" value="${fid}" name="fid"/><%--style--%>
                <input type="hidden" value="${tid}" name="tid"/><%--sid--%>
                <input type="hidden" name="id" id="id"/>
                <input type="hidden" name="fileType.id" id="filetypeid"/>
            </div>
