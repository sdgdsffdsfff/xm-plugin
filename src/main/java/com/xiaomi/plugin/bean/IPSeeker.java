...
import com.xiaomi.plugin.util.Utils;
...
//    private static IPSeeker instance = new IPSeeker();
    ...
    public void destroy() {
        if (ipFile != null) {
            try {
                ...
                System.out.println("IP地址信息文件引用关闭失败");
            }
        }
    }
    ...
    public void init() {
        ...
        b4 = new byte[4];
        b3 = new byte[3];
        String IP_FILE = IPSeeker.class.getResource("/ip.dat").toString().substring(5);
        try {
            ipFile = new RandomAccessFile(IP_FILE, "r");
        } catch (FileNotFoundException e) {
            System.out.println(IPSeeker.class.getResource("/ip.dat").toString());
